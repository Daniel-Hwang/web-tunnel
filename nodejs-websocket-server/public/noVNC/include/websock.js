...
(function () {
    ...
    Websock.prototype = {
        ...
        open: function (uri, lan_host, lan_port) {
		...
		var msg = Base64.encode(this._sQ);
		var newObj = {};
		newObj.seq = this.the_seq;
		newObj.type = "request";
		newObj.message = msg;
		...
		newObj.message = this.lan_host + ":" + this.lan_port;
		this.the_seq = obj.seq;
		var s = JSON.stringify(newObj);
		...
		return;
            ...
            try {
                this._decode_message(obj.message);
                if (this.rQlen() > 0) {
